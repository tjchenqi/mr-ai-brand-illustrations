...
Format:
16:9 horizontal. Clean composition with safe space for later subtitles and video overlays.
...
Composition:
Mr.Ai places a yellow guardrail before a red risk pit. Use blank label cards or very short labels only. Leave quiet blank space on the right side.
...
Format:
9:16 vertical. Clean composition with safe space for later subtitles and video overlays.
...
Composition:
Mr.Ai places a yellow guardrail before a red risk pit. Use blank label cards or very short labels only. Keep safe blank space at the top and bottom for subtitles.
...
Composition:
Mr.Ai nudges cards along a thin conveyor that splits useful output from noise. Use one physical metaphor only. Use thin arrows or a single route line if needed. Leave quiet blank space on the right side.
...
Composition:
Mr.Ai nudges cards along a thin conveyor that splits useful output from noise. Use one physical metaphor only. Use thin arrows or a single route line if needed. Keep safe blank space at the top and bottom for subtitles.
...
Composition:
Mr.Ai opens a simple dark box and reveals mechanism cards inside. Use one physical metaphor only. Use thin arrows or a single route line if needed. Leave quiet blank space on the right side.
...
Composition:
Mr.Ai opens a simple dark box and reveals mechanism cards inside. Use one physical metaphor only. Use thin arrows or a single route line if needed. Keep safe blank space at the top and bottom for subtitles.
