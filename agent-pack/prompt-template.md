...
Production default: do not ask the image model to render Chinese text. Image models may distort labels, translate them, or invent pseudo-letters.

- Generate blank label cards and add exact text in Remotion or editing.
- Keep label candidates in `shot-list.md`, `audio-visual-map.json`, and `remotion-overlay-notes.md`.
- Only test in-image Chinese after the no-text metaphor works.
- Reject generated images with wrong text unless they can be cleanly cropped or covered.
